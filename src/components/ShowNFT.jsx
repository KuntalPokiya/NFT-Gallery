            ...
            <div className='flex flex-col'>
              ...
              <div className='flex flex-col justify-start rounded-xl'>
                ...
                <p className='text-gray-400 text-xs my-0.5'>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum architecto ea et praesentium labore molestias, est vero ipsam saepe. Reiciendis velit amet quidem deserunt illum vero maxime tempora eum voluptates?
                </p>
                  ...
                  <div className='flex justify-start items-center'>
                    <Identicon className='h-10 w-10 object-contain rounded-full mr-3'
                     ...
                     <div className='flex flex-col justify-center items-start'>
                      ...
                      <small className='text-pink-800 font-bold'>0x31...03f2</small>
                     </div>
                  </div>
